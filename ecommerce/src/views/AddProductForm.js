    ...
    <>
        ...
        <form className="container prodForm" onSubmit={(event) =>{
            ...
            <div className="form-group">
                ...
                <input value={name} onChange={(event)=>{setName(event.target.value)}}  type="text" className="form-control" id="productName" placeholder="blue shirt">
                </input>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
                ...
                <input type="text" onChange={(event)=>{setBrand(event.target.value)}} className="form-control" id="productBrand" placeholder="Adidas">
                </input>
            </div>
            <div className="form-group">
                <label htmlFor="productSize">Sizes</label>
                <input type="text" onChange={(event)=>{setSize(event.target.value)}} className="form-control" id="productSizes" placeholder="6,7,8">
                </input>
            </div>
            <div className="form-group">
